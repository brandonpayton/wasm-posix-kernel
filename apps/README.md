...
- `signalling/` is a signalling server for connecting two Kandelo computers: one self-modifying PHP file that carries the invite and answer codes between them by session name.
